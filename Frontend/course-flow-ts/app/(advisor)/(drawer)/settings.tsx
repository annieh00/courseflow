  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]} contentContainerStyle={styles.content}>
      ...
      <View style={[styles.hero, { backgroundColor: theme.primary }]}>
        ...
        <Text style={styles.heroName}>{user?.name ?? 'Advisor'}</Text>
...
const styles = StyleSheet.create({
  ...
  heroEmail: { color: 'rgba(255,255,255,0.72)', fontSize: 14, marginTop: 4, textAlign: 'center' },
  roleBadge: {
    marginTop: 12,
  ...
  roleBadgeText: { color: '#fff', fontSize: 12, fontWeight: '700', letterSpacing: 0.6, textTransform: 'uppercase' },

  sectionLabel: { paddingHorizontal: 20, paddingTop: 24, paddingBottom: 8 },
  sectionLabelText: { fontSize: 12, fontWeight: '700', letterSpacing: 0.8 },
  ...
  ssoNote: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, paddingHorizontal: 16, paddingVertical: 12 },
  ssoNoteText: { fontSize: 12, flex: 1, lineHeight: 17 },

  logoutButton: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    marginHorizontal: 16, marginTop: 28, paddingVertical: 15,
    borderRadius: 16, borderWidth: 1.5, gap: 8,
  },
